...
void Message::copy(const Message& other)
{
    ...
    this->mes_type = other.mes_type;
    this->dest_name = other.dest_name;
}
...
void Message::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->mes_type);
    doParsimPacking(b,this->dest_name);
}
...
void Message::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->mes_type);
    doParsimUnpacking(b,this->dest_name);
}
...
int Message::getMes_type() const
{
    return this->mes_type;
}

void Message::setMes_type(int mes_type)
{
    this->mes_type = mes_type;
}

const char * Message::getDest_name() const
{
    return this->dest_name.c_str();
}

void Message::setDest_name(const char * dest_name)
{
...
int MessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='m' && strcmp(fieldName, "mes_type")==0) return base+2;
    if (fieldName[0]=='d' && strcmp(fieldName, "dest_name")==0) return base+3;
...
std::string MessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return long2string(pp->getMes_type());
        case 3: return oppstring2string(pp->getDest_name());
        default: return "";
    }
}
...
bool MessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setMes_type(string2long(value)); return true;
        case 3: pp->setDest_name((value)); return true;
