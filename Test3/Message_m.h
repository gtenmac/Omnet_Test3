...
class Message : public ::omnetpp::cMessage
{
  ...
  public:
    ...
    virtual int getMes_type() const;
    virtual void setMes_type(int mes_type);
    virtual const char * getDest_name() const;
    virtual void setDest_name(const char * dest_name);
};
